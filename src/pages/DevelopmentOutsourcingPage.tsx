  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto max-w-6xl">
          <ScrollFadeIn direction="up">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-bold text-foreground mb-4">Why Outsource Development?</h2>
      ...
      <section className="py-24 px-6 bg-secondary/30">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-foreground mb-4">Our Outsourcing Services</h2>
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
      ...
      <section id="models" className="py-24 px-6">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-foreground mb-4">Engagement Models</h2>
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
      ...
      <section className="py-24 px-6 bg-secondary/30">
        <ScrollFadeIn direction="up">
          <div className="container mx-auto max-w-4xl text-center">
            <h2 className="text-4xl font-bold text-foreground mb-6">Ready to Scale Your Team?</h2>
            <p className="text-xl text-muted-foreground mb-8 leading-relaxed">
